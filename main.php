...
<body>
    ...
    <nav class="nav nav_top">
        <div class="logo">
            <a href="#"><img src="logos.jpeg" width="300" ></a>
        </div>
        <div class="nav_side">
            <div class="btn">
    ...
    <div class="main_content"> 
        <p>“Every gun that is made, every warship launched, every rocket fired, signifies in the final sense a theft from those who hunger and are not fed, those who are cold and not clothed.”</p>
    </div>
...
<div class="counter-bgimage bgimage-property">
   <!-- <div class="container"> -->
    ...
    <img src="16t.jpeg"  class="img-responsive" width="100%" height="100%">
    </div>
    ...
    <div class="counter-img">
    <img src="17t.jpeg"  class="img-responsive">
    </div>
    ...
    <div class="col-xs-6 col-sm-2 text-center counter-col counter1-resSpace">
    <div class="counter-img">
    <img src="xx.jpg"  class="img-responsive">
    </div>
    <p class="counter-value top-space10"><span class="count">1</span></p>
